...
//       {/* Sidebar */}
//       <div className={`fixed inset-y-0 left-0 z-30 w-60 bg-white shadow transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:inset-0`}>
...
//             <StatCard title="Vest Violations" value={stats.vestViolations} color="yellow" />
